...
public class ExportData {
    ...
    public void karyawan(){
        try{
            ...
            fileOut = new FileOutputStream("C:\\Aplikasi MyDepot K'One\\Laporan\\Laporan Karyawan.xls");
    ...
    public void memesan(){
        try{
            ...
            Statement statement = con.createStatement();
            FileOutputStream fileOut;
            fileOut = new FileOutputStream("C:\\Aplikasi MyDepot K'One\\Laporan\\Laporan Pemesanan.xls");
            HSSFWorkbook workbook = new HSSFWorkbook();
            HSSFSheet worksheet = workbook.createSheet("Sheet 0");
            Row row1 = worksheet.createRow((short)0);
            ...
            Row row2 ;
            ResultSet rs = statement.executeQuery("SELECT nopesanan, id_p, id_k, id_g, nama_k, jmlpesanan, tglpesanan, biaya, diskon, voucher FROM memesan ");
    ...
    public void pelanggan(){
        try{
            ...
            Statement statement = con.createStatement();
            FileOutputStream fileOut;
            fileOut = new FileOutputStream("C:\\Aplikasi MyDepot K'One\\Laporan\\Laporan Pelanggan.xls");
            HSSFWorkbook workbook = new HSSFWorkbook();
            HSSFSheet worksheet = workbook.createSheet("Sheet 0");
            Row row1 = worksheet.createRow((short)0);
